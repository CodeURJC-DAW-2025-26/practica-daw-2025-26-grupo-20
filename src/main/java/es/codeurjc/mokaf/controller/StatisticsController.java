...
public class StatisticsController {
    ...
    public String viewCharts(Model model) {
        ...
        // Add explicit flags
        model.addAttribute("hasBestProduct", bestProduct != null && bestProduct.containsKey("exists") && (boolean)bestProduct.get("exists"));
        model.addAttribute("hasTopRatedProduct", topRatedProduct != null && topRatedProduct.containsKey("exists") && (boolean)topRatedProduct.get("exists")); // NEW
        model.addAttribute("hasTopCategory", topCategory != null && topCategory.containsKey("exists") && (boolean)topCategory.get("exists"));
        model.addAttribute("hasTopBranch", topBranch != null && topBranch.containsKey("exists") && (boolean)topBranch.get("exists"));
